...
#'
#' @export
PlotPatrial<-function(data,var="",xlim=range(data$PatrialData$x), ylim=range(data$PatrialData$pa),log="",
  ...
  if("YesOrNO" %in% names(data)){data=data}else(data=RePatrial(var,data)}
